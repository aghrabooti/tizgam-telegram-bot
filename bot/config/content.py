...
# ── برچسب‌ها و متن‌های جمع‌آوری شماره تماس ──
LBL_SHARE_CONTACT = "📱 ارسال شماره تماس"
LBL_PHONE_LATER = "⏭ بعداً"

PHONE_REQUEST_TEXT = (
    "📱 <b>قبل از شروع، یک قدم کوچک!</b>\n\n"
    "برای دریافت <b>مشاوره‌ی رایگان</b> و اطلاع از تخفیف‌های ویژه‌ی «تیزپک»،"
    " لطفاً شماره‌ی تماس خود را ارسال کنید.\n\n"
    "🔐 شماره‌ی شما فقط برای ارتباط مشاوران تیزگام استفاده می‌شود و نزد ما"
    " محفوظ است.\n\n"
    "👉 روی دکمه‌ی «📱 ارسال شماره تماس» بزنید تا شماره مستقیماً از تلگرام"
    " ارسال شود، یا شماره را تایپ کنید (مثال: ۰۹۱۲۳۴۵۶۷۸۹)."
)
PHONE_THANKS_TEXT = (
    "✅ سپاسگزاریم! شماره‌ی شما ثبت شد.\n\n"
    "حالا از منوی زیر استفاده کنید 👇"
)
PHONE_LATER_ACK_TEXT = (
    "👍 باشه! هر وقت خواستید می‌توانید شماره‌ی خود را برای ما بفرستید.\n\n"
    "منوی اصلی 👇"
)
PHONE_INVALID_TEXT = (
    "⚠️ شماره‌ی واردشده معتبر به نظر نمی‌رسد.\n\n"
    "لطفاً با دکمه‌ی «📱 ارسال شماره تماس» یا به‌صورت دستی"
    " (مثل ۰۹۱۲۳۴۵۶۷۸۹) بفرستید."
)
